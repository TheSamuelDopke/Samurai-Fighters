...
startGame.addEventListener('click', () =>{
    if(birds.velocity.y == 0 && birds.position.y == 160 && birds.velocity.x == 0 && birds.position.x == 750 && leftright == undefined){
            moveBird()
    }
...
var spanTimer = document.querySelector('.spanTimer')
var spanDamage = document.querySelector('.spanDamage')

inputTimer.addEventListener('input', () =>{
    spanTimer.innerHTML = inputTimer.value
})

inputDamage.addEventListener('input', () =>{
    spanDamage.innerHTML = inputDamage.value
})
